...
DAYTIME_DICT_FILE = r'/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/script_cariad/config/BWD_daytime.json'
with open(DAYTIME_DICT_FILE, 'r') as f:
    DAYTIME_DICT = json.load(f)
    
PATH_ITRK = r"/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/BWD_MID_itrks_20220706/"
# PATH_ITRK = r"/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/ITRK_BWD_CP60"
PATH_RESULT = r'/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/logs'
PATH_FAILED_KPI_DFS = r'/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/script_cariad/FAILED_KPI_DFS'
CP60_SPEC_PATH = r"/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/cp60_staged_lists/merged_admcp_and_adcam/snow_list.json"
CP_60_PICKLES_FILE_LIST = r"/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/cp60_staged_lists/f_snow_list.json"
# bad label dictionaries to use in KPIs, used by mainLogic.py
BAD_LABEL_DICT_FOLDER = r'/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/script_cariad/BWD_BAD_LABELS'
# partials to use for bad label dictionaries, used by bad_label_finder.py
BAD_LABELS_PATH_TO_PARTIAL_RESULTS_CP60 = r'/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/output/SOP8_A360_NEW_LOGIC_CP60_DAYNIGHT_08_invalid_label/spi_backup'
BAD_LABELS_PATH_TO_PARTIAL_RESULTS_MID = r'/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/output/SOP8_A360_NEW_LOGIC_MID_DAYNIGHT_08_invalid_label/spi_backup'
...
KPI_GENERATOR_OUTPUT_FOLDER = r"/net/8k3/e0fs01/irods/PLKRA-PROJECTS/ADCAM/7-Tools/ADCAM/BWD/output/CARIAD_X060_004"
...
VALID_SEVERITY_LAB = {LAB_BLUR_IMAGE: [4, 5],  # Nie było 4, czemu?
                      LAB_FOG: [2, 5],
