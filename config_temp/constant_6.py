...
PROJECT = setup.SOP
DONT_CHECK_ZERO_SPEED = setup.DONT_CHECK_ZERO_SPEED
...
SEVERITY_BACKUP_SPI = {
    LAB_BLUR_IMAGE: {4: {SYS_BLUR: [4], SYS_FOG: [2, 5], SYS_FROZEN_WINDSHIELD: [2, 4, 5], SYS_FADING_BY_SUN: [2, 4, 5], SYS_RAIN: [4], SYS_ROAD_SPRAY: [4]},
                     5: {SYS_BLUR: [5], SYS_FOG: [5], SYS_FROZEN_WINDSHIELD: [4, 5], SYS_FADING_BY_SUN: [5], SYS_RAIN: [5], SYS_ROAD_SPRAY: [5]}},
    LAB_FOG: {2: {SYS_FOG: [2, 4], SYS_BLUR: [4]},
              5: {SYS_FOG: [4, 5], SYS_BLUR: [5]}},
    ...
    LAB_OOF: {5: {SYS_OUT_OF_FOCUS: [5]}}
}

SEVERITY_BACKUP_SPI_ONE_LEVEL_UP_DOWN = {
    LAB_BLUR_IMAGE: {4: {SYS_BLUR: [4, 5], SYS_FOG: [2, 5], SYS_FROZEN_WINDSHIELD: [2, 4, 5], SYS_FADING_BY_SUN: [2, 4, 5], SYS_RAIN: [2, 4, 5], SYS_ROAD_SPRAY: [2, 4, 5]},
    ...
    LAB_FROZEN_WINDSHIELD: {2: {SYS_FROZEN_WINDSHIELD: [2, 4], SYS_BLUR: [4], SYS_FOG: [2, 5], SYS_FULL_BLOCKAGE: [5], SYS_PARTIAL_BLOCKAGE: [2, 4]},
    ...
    LAB_FULL_BLOCKAGE: {5: {SYS_FULL_BLOCKAGE: [5], SYS_FROZEN_WINDSHIELD: [4, 5], SYS_PARTIAL_BLOCKAGE: [4, 5]}},
    LAB_LOWSUN: {2: {SYS_FADING_BY_SUN: [2, 4], SYS_SUN_RAY: [2, 4]},
                 4: {SYS_FADING_BY_SUN: [2, 4, 5], SYS_SUN_RAY: [2, 4, 5]},
                 5: {SYS_FADING_BY_SUN: [4, 5], SYS_SUN_RAY: [4, 5]}},
    LAB_SUNRAY: {2: {SYS_SUN_RAY: [2, 4], SYS_FADING_BY_SUN: [2, 4]},
